...
public class COSC489_PT_Kdriley0 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            if (input.compareTo("insert") == 0|| input.compareTo("i") == 0){
            ...
            if (input.compareTo("delete") == 0 ||input.compareTo("d") == 0) {
                nr.delete();
            }
            if (input.compareTo("append") == 0) {
                System.out.println("what number do you want to append?");
                num = scan.nextInt();
                nr.Append(num);
            }
            if (input.compareTo("sort") == 0||input.compareTo("s") == 0) {
                nr.sort();
            }
